...
{	
    ...
    public function rules()
    {
        return [
            ...
            [['education', 'education_start_time', 'education_end_time', 'university', 'university_category', 'education2', 'academy2', 'university_style2', 'university_degree2', 'university_category2', 'degree2', 'category2', 'education_number2', 'education_major2', 'professional_ranking2', 'educations_number2', 'education_start_time2', 'education_end_time2', 'status'], 'required', 'on'=>['step2']],
            [['fulltime_work_life', 'management_work_life', 'chinese_company_name', 'main_business', 'Industry_category', 'company_nature', 'post_type', 'work_department', 'work_position', 'work_function1', 'work_function2', 'work_starttime', 'superior_name', 'superior_post', 'superior_phone', 'agree_contact_suoerior', 'status'], 'required', 'on'=>['step3']],
            [['card_front', 'card_back', 'diploma_scan', 'postgraduate_diploma_scan', 'report_card', 'postgraduate_report_card', 'resume_chinese', 'resume_english', 'english_essays', 'additional_material', 'status'], 'required', 'on'=>['step4']],
